...
-(void) adjustViewForBanner
{
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone)
    {
        if(bannerViewHide)
        {
            //            CGRect rect = self.buttonLabelView.frame;
            //            rect.origin.y = self.view.frame.size.height - 27;
            //            self.buttonLabelView.frame = rect;
            //
            //            rect = self.dummyView.frame;
            //            rect.size.height = self.buttonLabelView.frame.origin.y - 15;
            //            self.dummyView.frame = rect;
        }
        else{
            //            dummyView.backgroundColor = [UIColor colorWithRed:220.0/255.0 green:220.0/255.0 blue:220.0/255.0 alpha:1.0];
            //
            //            CGRect rect = self.buttonLabelView.frame;
            //            rect.origin.y = self.bannerView.frame.origin.y - 26;
            //            self.buttonLabelView.frame = rect;
            //
            //            rect = self.dummyView.frame;
            //            rect.size.height = self.buttonLabelView.frame.origin.y - 15;
    ...
    }else
    {
        if(bannerViewHide)
        {
            //            dummyView.backgroundColor = [UIColor colorWithRed:180.0/255.0 green:180.0/255.0 blue:180.0/255.0 alpha:1.0];
            //            CGRect rect = self.buttonLabelView.frame;
            //            rect.origin.y = self.view.frame.size.height - 60;
            //            self.buttonLabelView.frame = rect;
            //
            //            rect = self.dummyView.frame;
            //            rect.size.height = self.buttonLabelView.frame.origin.y - 50;
            //self.dummyView.frame = rect;
        }
        else{
            //            dummyView.backgroundColor = [UIColor colorWithRed:220.0/255.0 green:220.0/255.0 blue:220.0/255.0 alpha:1.0];
            //
            //            CGRect rect = self.buttonLabelView.frame;
            //            rect.origin.y = self.bannerView.frame.origin.y - 70;
            //            self.buttonLabelView.frame = rect;
            //
            //            rect = self.dummyView.frame;
            //            rect.size.height = self.buttonLabelView.frame.origin.y - 50;
